...
const generateAccessAndRefereshTokens = async(userId) =>{
    try {
        ...
        //password is not there in user t initial 
        //without validateBeforeSave: false the password required checking is also triggered 
        //so for save without checking constraints and required field we use validateBeforeSave: false
